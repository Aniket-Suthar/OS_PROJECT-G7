...
btnAdd.addEventListener('click', function addRow(e) {
    ...
    if (selectedRow == null) {
        ...
        cell1.innerHTML = parseInt(Alloc_A);
        cell2.innerHTML = parseInt(Alloc_B);
        cell3.innerHTML = parseInt(Alloc_C);
        ...
        cell7.innerHTML = Max_A;
        cell8.innerHTML = Max_B;
        cell9.innerHTML = Max_C;
    ...
    for (let i = 0; i < totalProcesses; i++) {
        ...
        for (let i = 0; i <totalProcesses; i++) {
            ...
            totalall_C += allocation_arr_C[i];
                ...
                var row2 = table2.insertRow(count);
                ...
                cell4.innerHTML = Math.abs(maxNeed_A[i] - allocation_arr_A[i]);
                cell5.innerHTML =  Math.abs(maxNeed_B[i] - allocation_arr_B[i]);
                cell6.innerHTML =  Math.abs(maxNeed_C[i] - allocation_arr_C[i]);
